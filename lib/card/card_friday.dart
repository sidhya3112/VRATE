...
class cardFri extends StatefulWidget {
  @override
  _cardFriState createState() => _cardFriState();
}

class _cardFriState extends State<cardFri> {
...
class _FridayState extends State<Friday> {
  ...
  var list3 =["BEE LAB", "BREAK" , "BREAK" , "BREAK", "PCW LAB" , "PCW LAB" , "BEE LAB", "BEE LAB"];
