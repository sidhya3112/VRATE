...
class cardWed extends StatefulWidget {
  @override
  _cardWedState createState() => _cardWedState();
}

class _cardWedState extends State<cardWed> {
...
class _WednesdayState extends State<Wednesday> {
  ...
  var list3 =["BEE LAB", "BREAK" , "Applied Physics" , "BREAK", "PCW LAB" , "PCW LAB" , "EME", "Applied Mathematics"];
