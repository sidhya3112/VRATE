...
class FeedbackPageChem extends StatefulWidget {
  @override
  _FeedbackPageChemState createState() => _FeedbackPageChemState();
}

class _FeedbackPageChemState extends State<FeedbackPageChem> {
