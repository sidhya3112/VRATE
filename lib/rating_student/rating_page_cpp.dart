...
import 'feedback_page_cpp.dart';

class RatingPageCpp extends StatefulWidget {
  @override
  _RatingPageCppState createState() => _RatingPageCppState();
}

class _RatingPageCppState extends State<RatingPageCpp> {
  ...
  Widget build(BuildContext context) {
    _feedbackButtonPressed() {
      setState(() {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => FeedbackPageCpp()));
      });
    }
