...
import 'feedback_page_eme.dart';


class RatingPageEme extends StatefulWidget {
  @override
  _RatingPageEmeState createState() => _RatingPageEmeState();
}

class _RatingPageEmeState extends State<RatingPageEme> {
  ...
  Widget build(BuildContext context) {
    _feedbackButtonPressed() {
      setState(() {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => FeedbackPageEme()));
      });
    }
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    CircleAvatar(
                      backgroundImage: AssetImage("images/eme.png"),
                      radius: 30,
                    ),
                    SizedBox(
                      height: 20,
