...
import 'feedback_page_math.dart';


class RatingPageMath extends StatefulWidget {
  @override
  _RatingPageMathState createState() => _RatingPageMathState();
}

class _RatingPageMathState extends State<RatingPageMath> {
  ...
  Widget build(BuildContext context) {
    _feedbackButtonPressed() {
      setState(() {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => FeedbackPageMath()));
      });
    }
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    CircleAvatar(
                      backgroundImage: AssetImage("images/math.jpg"),
                      radius: 30,
                    ),
                    SizedBox(
                      height: 20,
