...
import 'feedback_page_pcwlab.dart';


class RatingPagePCW extends StatefulWidget {
  @override
  _RatingPagePCWState createState() => _RatingPagePCWState();
}

class _RatingPagePCWState extends State<RatingPagePCW> {
  ...
  Widget build(BuildContext context) {
    _feedbackButtonPressed() {
      setState(() {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => FeedbackPagePCW()));
      });
    }
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    CircleAvatar(
                      backgroundImage: AssetImage("images/pcw.jpg"),
                      radius: 30,
                    ),
                    SizedBox(
                      height: 20,
