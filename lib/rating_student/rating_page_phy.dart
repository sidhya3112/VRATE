...
import 'feedback_page_phy.dart';

class RatingPagePhy extends StatefulWidget {
  @override
  _RatingPagePhyState createState() => _RatingPagePhyState();
}

class _RatingPagePhyState extends State<RatingPagePhy> {
  ...
  Widget build(BuildContext context) {
    _feedbackButtonPressed() {
      setState(() {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => FeedbackPagePhy()));
      });
    }
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    CircleAvatar(
                      backgroundImage: AssetImage("images/phy.jpg"),
                      radius: 30,
                    ),
                    SizedBox(
                      height: 20,
